...
```{r, fig.cap="Arrival in Ourense on the way to the AirBnB."}
knitr::include_graphics("IMG_20190522_194521.jpg")
```



```{r, fig.cap="Delete this photo"}
...
knitr::include_graphics("IMG_20190523_094920.jpg")
```
...
```{r, fig.cap="The first stage of the Camino."}
...
knitr::include_graphics("IMG_20190523_175552.jpg")
```
...
```{r, fig.cap="View from our window after the first day of walking the Camino."}
